...
public class PostController {
    ...
    public String list(Model model){
        ...
        model.addAttribute("posts",postService.list()/*createPosts()*/);
        return "views/list";
    }

    @RequestMapping(value="view/{postId}/", method = RequestMethod.GET)
    public String view(@PathVariable("postId") String postId, Model model) {
        model.addAttribute("post", postService.getBySlug(postId));
        return "post/view";
    }
    ...
    private ArrayList<Post> createPosts(){
        ...
        post1.setAuthor(new Author("Dan","Vega"));
        ...
        post2.setAuthor(new Author("Dan","Vega"));
